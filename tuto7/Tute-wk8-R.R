...
garch11.fit.palm <- ugarchfit(ret.palm, spec = spec1, solver = "gosolnp", out.sample=5) # Model estimation 

print(garch11.fit.palm)

one=0.027095+0.138111*0.168246^2+0.756130*0.435722^2

two=0.027095+(0.138111+0.756130)*one

three=0.027095+(0.138111+0.756130)*two
...
forc = ugarchforecast(garch11.fit.palm, n.ahead=5)
